  ...
  tabsetPanel(
    ...
    tabPanel("Blog: TF Footprinting on Disease",
             fluidPage(
               ...
               img(src = "https://raw.githubusercontent.com/rootze/scCis-TF/main/images/TF_Footprinting_Scenario.png", height = "300px", width = "100%", style = "display: block; margin: 0 auto;"),
