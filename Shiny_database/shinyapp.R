  ...
  tabsetPanel(
    tabPanel("Home",
             fluidPage(
               ...
               img(src = "https://raw.githubusercontent.com/rootze/scCis-TF/main/images/scROAD_GWAS_snATAC.png", height = "800px"),
               hr(),
    ...
    tabPanel("Introductory Vignettes",
        ...
        ")),
               ...
               img(src = "https://raw.githubusercontent.com/rootze/scCis-TF/main/images/scROAD_IntroductoryVignettes.png", height = "800px", style="display: block; margin-left: auto; margin-right: auto;")
             )
    ),
    ...
    tabPanel("Blog: TF Footprinting on Disease",
             fluidPage(
               ...
               img(src = "https://raw.githubusercontent.com/rootze/scCis-TF/main/images/TF_Footprinting_Scenario.png", height = "450px", width = "100%", style = "display: block; margin: 0 auto;"),
